...
if ( !nort ) nort = {}
if ( !nort.i18n) nort.i18n = {}

nort.i18n.localeDefs= {
    "def" : {
...
class Locale {
   constructor(locName) {
      this.locData = nort.i18n.localeDefs[locName]
      if (this.locData === undefined ) this.locData = nort.i18n.localeDefs['def']
