...
export function listMenu(attributes, optionList) {
    ...
    return elements.bindFieldMethods(element)
}

export function comboBox(attributes, optionList) {
    let attClass = " " + attributes.class || ""

    let e = elements.bindFieldMethods(dom.createElement("input", {class: "combobox"+ attClass, type: "text", "nort-element":"combobox"}, [attributes]))
    let cal
